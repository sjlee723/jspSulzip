          ...
          <div class="col-md-6">
            <div class="card-body">
              ...
              <div class="row price-area1">
                <div class="col-3">
                  <span id="unit_price">
                  <fmt:formatNumber value="${ingredients.getProductPrice()}" pattern="#,###"/>
                  </span>
              ...
              <div class="row price-area2">
                <div class="col-12" style="text-align: right;">
                  <span>총 수량</span>&nbsp;<span id="total_num">1</span><span>&nbsp;개&nbsp;&nbsp;|&nbsp;&nbsp;</span><span id="price"><fmt:formatNumber value="${ingredients.getProductPrice()}" pattern="#,###"/></span>
