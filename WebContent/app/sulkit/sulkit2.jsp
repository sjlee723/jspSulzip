        ...
        <div class="content">
            ...
            <div class="list-group">
                <div class="card-group">
                    ...
                    <div class="card">
                        <img src="${pageContext.request.contextPath}/assets/img/sulkit/jackrose_1.jpg" class="card-img-top" alt="잭로즈이미지">
                        <div class="card-body">
                            <p class="card-text-1">술키트</p>
                            <h5 class="card-title">잭로즈</h5>
                ...
                <div class="card-group">
                    <div class="card">
                        <img src="${pageContext.request.contextPath}/assets/img/sulkit/jintonic-1.jpg" class="card-img-top" alt="진토닉이미지">
                        <div class="card-body">
                            <p class="card-text-1">술키트</p>
                            <h5 class="card-title">진토닉</h5>
                            <p class="card-text-2"><small class="text-muted">27,500원</small></p>
                        </div>
                    </div>
                    <div class="card">
                        <img src="${pageContext.request.contextPath}/assets/img/sulkit/junebug_1.jpg" class="card-img-top" alt="준벅이미지">
                        <div class="card-body">
                            <p class="card-text-1">술키트</p>
                            <h5 class="card-title">준벅</h5>
                            <p class="card-text-2"><small class="text-muted">31,500원</small></p>
                        </div>
                    </div>
                    <div class="card">
                        <img src="${pageContext.request.contextPath}/assets/img/sulkit/kahluamilk_1.jpg" class="card-img-top" alt="깔루아밀크">
                        <div class="card-body">
                            <p class="card-text-1">술키트</p>
                ...
                <div class="card-group">
                    <div class="card">
                        <img src="${pageContext.request.contextPath}/assets/img/sulkit/kamikaze_1.jpg" class="card-img-top" alt="카미카제이미지">
                        <div class="card-body">
                            <p class="card-text-1">술키트</p>
                            <h5 class="card-title">카미카제</h5>
                            <p class="card-text-2"><small class="text-muted">41,000원</small></p>
                        </div>
                    </div>
                    <div class="card">
                        <img src="${pageContext.request.contextPath}/assets/img/sulkit/lemondrop_1.jpg" class="card-img-top" alt="레몬드롭이미지">
                        <div class="card-body">
                            <p class="card-text-1">술키트</p>
                            <h5 class="card-title">레몬드롭</h5>
                            <p class="card-text-2"><small class="text-muted">37,500원</small></p>
                        </div>
                    </div>
                    <div class="card">
                        <img src="${pageContext.request.contextPath}/assets/img/sulkit/longislandicedtea-1.jpg" class="card-img-top" alt="롱아일랜드아이스티이미지">
                        <div class="card-body">
                            <p class="card-text-1">술키트</p>
                            <h5 class="card-title">롱아일랜드아이스티</h5>
                ...
                <div class="card-group">
                    <div class="card">
                        <img src="${pageContext.request.contextPath}/assets/img/sulkit/manhattan-1.jpg" class="card-img-top" alt="맨하탄이미지">
                        <div class="card-body">
                            <p class="card-text-1">술키트</p>
                            <h5 class="card-title">맨하탄</h5>
                            <p class="card-text-2"><small class="text-muted">32,000원</small></p>
                        </div>
                    </div>
                    <div class="card">
                        <img src="${pageContext.request.contextPath}/assets/img/sulkit/margarita_1.jpg" class="card-img-top" alt="마가리타이미지">
                        <div class="card-body">
                            <p class="card-text-1">술키트</p>
                            <h5 class="card-title">마가리타</h5>
                            <p class="card-text-2"><small class="text-muted">45,000원</small></p>
                        </div>
                    </div>
                    <div class="card">
                        <img src="${pageContext.request.contextPath}/assets/img/sulkit/martinigin_1.jpg" class="card-img-top" alt="마티니진이미지">
                        <div class="card-body">
                            <p class="card-text-1">술키트</p>
                            <h5 class="card-title">마티니진</h5>
                            <p class="card-text-2"><small class="text-muted">41,000원</small></p>
                        </div>
                    </div>
                </div>
