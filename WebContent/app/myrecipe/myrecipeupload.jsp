...
<body>
	...
	<main>
		<div class="upload-container">
			...
			<form action="/myrecipe/myRecipeUploadOk.mrb" method="post"
				enctype="multipart/form-data">
				<input type="file" name="myRecipeFile1" id=""
					class="myRecipeFileInput" /><br /> <input type="file"
					name="myRecipeFile2" id="" class="myRecipeFileInput" /><br /> <input
					type="file" name="myRecipeFile3" id="" class="myRecipeFileInput" /><br />
