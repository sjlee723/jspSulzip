	...
	<main>
		<div class="upload-container">
			...
			<form action="/myrecipe/myRecipeUpdateOk.mrb" method="post" enctype="multipart/form-data">
				...
				<input type="text" class="input" name="myRecipeNameKor" value="${myRecipeDTO.getMyRecipeNameKor()}" required/>
				<div class="name-title">
					<span>칵테일 영문 이름</span>
				</div>
				<input type="text" class="input" name="myRecipeNameEng" value="${myRecipeDTO.getMyRecipeNameEng()}" required/>
				<!-- 상품 설명 -->
				<div class="pro-info-title">
					<span>칵테일 설명</span>
				</div>
				<textarea name="myRecipeDesc" id="" cols="30" rows="10" class="info-input" required>${myRecipeDTO.getMyRecipeDesc()}</textarea>
				<!-- 재료 -->
              ...
              <path
				...
				<div class="input-box">
					<textarea name="myRecipeRecipe" id="" cols="30" rows="10" class="recipe-input" required>${myRecipeDTO.getMyRecipeRecipe()}</textarea>
				</div>
				<!-- 등록버튼 -->
