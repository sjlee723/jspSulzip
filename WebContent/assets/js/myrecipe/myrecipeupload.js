...
$('.all').on('change', '.category', function(){
	var v = $(this).val();
		if (v == 2) {
			$(this).siblings('.myrecipe-alcohol').show();
			$(this).siblings('.myrecipe-ingre').hide();
			$(this).siblings('.myrecipe-vol').show();
		} else if (v == 3) {
			$(this).siblings('.myrecipe-alcohol').hide();
			$(this).siblings('.myrecipe-ingre').show();
			$(this).siblings('.myrecipe-vol').show();
		} else if (v == 1) {
			$(this).siblings('.myrecipe-alcohol').hide();
			$(this).siblings('.myrecipe-ingre').hide();
			$(this).siblings('.myrecipe-vol').hide();
		}
});
