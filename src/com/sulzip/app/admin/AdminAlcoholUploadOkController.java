...
public class AdminAlcoholUploadOkController implements Execute {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String uploadPath = req.getSession().getServletContext().getRealPath("/") + "assets/img/alcohol/";
...
//		업로드 후 작성된 글로 이동
		...
		resp.sendRedirect("/product/alcohol.prd");
